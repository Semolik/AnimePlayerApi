...
@api_router.post("/titles/{title_id}/favorite", response_model=None, status_code=204)
...
@api_router.delete("/titles/{title_id}/favorite", response_model=None, status_code=204)
